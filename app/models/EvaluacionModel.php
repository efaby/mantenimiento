...
class EvaluacionModel {
	...
	public function getlistadoPraticas($docente){
		$model = new BaseModel();	
		$sql = "select p.*, eva.duracion_practica, eva.nota_practica, u.nombres, u.apellidos, pa.nombre as paralelo, eva.id as evaluacion_id from practica as p
	...
	public function getEvaluacion()
	{
		$evaluacion = $_GET['id'];
		$model = new BaseModel();		
		$sql = "select e.*, p.nombre as practica, pa.nombre as paralelo, u.nombres, u.apellidos from evaluacion as e
