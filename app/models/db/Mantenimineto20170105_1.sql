...
CREATE TABLE `activo_plan` (
  ...
  `frecuencia_alerta_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `activo_plan` VALUES (2,2,1,0.00,3,1,0,'2017-01-04','2017-01-04',0,0),(3,1,1,0.00,3,2,0,'2017-01-05','2017-01-05',0,0);
...
-- Dump completed on 2017-01-05 12:30:09
