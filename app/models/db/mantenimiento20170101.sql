...
INSERT INTO `activo_fisico` (`id`,`version`,`nombre_activo`,`ficha`,`codigo`,`inventario`,`manual_fabricante`,`seccion`,`marca_maquina`,`modelo_maquina`,`serie_maquina`,`color`,`pais_origen`,`capacidad`,`caracteristicas`,`marca_motor`,`tipo_he`,`num_fases`,`rpm`,`voltaje_motor`,`hz`,`amperios_motor`,`kw`,`imagen_maquina_url`,`tipo_motor_id`,`partes_maquina_id`,`nomenglatura_url`,`funcion`,`nombre`,`diagram_proceso_url`,`alias`) VALUES 
 (1,'','','','001',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/images',1,1,NULL,NULL,'maquina 1',NULL,'');
